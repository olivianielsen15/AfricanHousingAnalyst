...
.hero-right { flex: 0.9; display: flex; justify-content: center; min-width: 0; }
...
@media (max-width: 768px) {
    .hero-content { flex-direction: column; padding: 1.5rem; }
...
<div class="hero-container">
      ...
      <svg viewBox="0 0 500 550" class="africa-map" xmlns="http://www.w3.org/2000/svg">
        ...
        <g class="city-group city-1" transform="translate(310,82)">
          ...
          <g class="house" filter="url(#shadow)">
            <rect x="-8" y="-22" width="16" height="14" rx="1" fill="#ff8f00"/>
            <polygon points="-10,-22 0,-30 10,-22" fill="#e65100"/>
        ...
        <g class="city-group city-2" transform="translate(148,68)">
          ...
          <g class="house" filter="url(#shadow)">
            <rect x="-6" y="-19" width="12" height="11" rx="1" fill="#1565c0"/>
            <polygon points="-8,-19 0,-26 8,-19" fill="#0d47a1"/>
        ...
        <g class="city-group city-3" transform="translate(100,120)">
          ...
          <circle r="3" fill="#4caf50" opacity="0.3" class="city-dot"/>
          <g class="house" filter="url(#shadow)">
            <rect x="-6" y="-19" width="12" height="11" rx="1" fill="#6a1b9a"/>
            <polygon points="-8,-19 0,-26 8,-19" fill="#4a148c"/>
        ...
        <g class="city-group city-4" transform="translate(130,155)">
          ...
          <circle r="3" fill="#4caf50" opacity="0.3" class="city-dot"/>
          <g class="house" filter="url(#shadow)">
            <rect x="-6" y="-19" width="12" height="11" rx="1" fill="#00838f"/>
            <polygon points="-8,-19 0,-26 8,-19" fill="#006064"/>
        ...
        <g class="city-group city-5" transform="translate(155,168)">
          ...
          <circle r="4" fill="#4caf50" opacity="0.3" class="city-dot"/>
          <g class="house" filter="url(#shadow)">
            <rect x="-8" y="-22" width="16" height="14" rx="1" fill="#2e7d32"/>
            <polygon points="-10,-22 0,-30 10,-22" fill="#1b5e20"/>
        ...
        <g class="city-group city-6" transform="translate(200,200)">
          ...
          <circle r="3" fill="#4caf50" opacity="0.3" class="city-dot"/>
          <g class="house" filter="url(#shadow)">
            <rect x="-5" y="-17" width="10" height="9" rx="1" fill="#ef6c00"/>
            <polygon points="-7,-17 0,-23 7,-17" fill="#e65100"/>
        ...
        <g class="city-group city-7" transform="translate(325,195)">
          ...
          <g class="house" filter="url(#shadow)">
            <rect x="-7" y="-20" width="14" height="12" rx="1" fill="#c62828"/>
            <polygon points="-9,-20 0,-28 9,-20" fill="#b71c1c"/>
        ...
        <g class="city-group city-8" transform="translate(260,280)">
          ...
          <circle r="3" fill="#4caf50" opacity="0.3" class="city-dot"/>
          <g class="house" filter="url(#shadow)">
            <rect x="-5" y="-17" width="10" height="9" rx="1" fill="#1565c0"/>
            <polygon points="-7,-17 0,-23 7,-17" fill="#0d47a1"/>
        ...
        <g class="city-group city-9" transform="translate(335,265)">
          ...
          <circle r="4" fill="#4caf50" opacity="0.3" class="city-dot"/>
          <g class="house" filter="url(#shadow)">
            <rect x="-8" y="-22" width="16" height="14" rx="1" fill="#d84315"/>
            <polygon points="-10,-22 0,-30 10,-22" fill="#bf360c"/>
        ...
        <g class="city-group city-10" transform="translate(325,320)">
          ...
          <circle r="3" fill="#4caf50" opacity="0.3" class="city-dot"/>
          <g class="house" filter="url(#shadow)">
            <rect x="-6" y="-19" width="12" height="11" rx="1" fill="#00695c"/>
            <polygon points="-8,-19 0,-26 8,-19" fill="#004d40"/>
        ...
        <g class="city-group city-11" transform="translate(175,310)">
          ...
          <circle r="3" fill="#4caf50" opacity="0.3" class="city-dot"/>
          <g class="house" filter="url(#shadow)">
            <rect x="-5" y="-17" width="10" height="9" rx="1" fill="#f9a825"/>
            <polygon points="-7,-17 0,-23 7,-17" fill="#f57f17"/>
        ...
        <g class="city-group city-12" transform="translate(270,380)">
          ...
          <circle r="3" fill="#4caf50" opacity="0.3" class="city-dot"/>
          <g class="house" filter="url(#shadow)">
            <rect x="-5" y="-17" width="10" height="9" rx="1" fill="#558b2f"/>
            <polygon points="-7,-17 0,-23 7,-17" fill="#33691e"/>
        ...
        <g class="city-group city-13" transform="translate(280,460)">
          ...
          <g class="house" filter="url(#shadow)">
            <rect x="-9" y="-24" width="18" height="15" rx="1" fill="#1a237e"/>
            <polygon points="-11,-24 0,-33 11,-24" fill="#0d1642"/>
        ...
        <g class="city-group city-14" transform="translate(310,470)">
          ...
          <g class="house" filter="url(#shadow)">
            <rect x="-5" y="-17" width="10" height="9" rx="1" fill="#ad1457"/>
            <polygon points="-7,-17 0,-23 7,-17" fill="#880e4f"/>
  ...
  <div class="stats-bar">
    <div class="stat-item">
      <div class="stat-number">~160M</div>
